...
API_KEY_SUPER_JOB = 'v3.r.137990716.0365575c0412ea6451065692f70011d68d288c11.6dcd1b62e1b1fc75a3d378ac6df2d53be7566534'


class VacanciesGETClass(ABC):
    """ Класс получения вакансий """  # класс работы с API (HH, SJ)
...
class HeadHunterAPI(VacanciesGETClass):
    ...
    def get_vacancies(self, pages_count=2):
        ...
        for page in range(pages_count):
            ...
            print( f"({self.__class__.__name__}) страница № {page + 1} -", end=" ")
...
class SuperJobAPI(VacanciesGETClass):
    ...
    def get_request(self):
        ...
        response = requests.get(url_sj, params=self.params, headers=headers)
    ...
    def modify_data(self):
        ...
        for vacanc in self.vacancies:
            formalized_dict = {
                ...
                'requirement': vacanc.get('vacancyRichText', ''),
                'responsibility': vacanc.get('candidat', ''),
                'api': 'SuperJob'
            }
            form_vacancies.append(formalized_dict)
        return form_vacancies
